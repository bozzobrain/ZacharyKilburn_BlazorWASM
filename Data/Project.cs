...
namespace ZacharyKilburn_BlazorWASM.Data
{
	...
	public class ProjectLoader
	{
		...
		public static readonly Project BMEBike = new()
		{
			...
			ProjectDate = "2018",
			ProjectDescription = "hstart Project Description hend A small team of The University of Akron engineering students designed/constructed a handi-capable assisted bicycle that helped a local boy with spinocerebellar ataxia able to ride. " +
			"\n\n hstart Design hend" +
