namespace ZacharyKilburn_BlazorWASM.Data
{
    ...
    public class BoardLoader
	{
		...
		public static readonly Board Z21 = new()
        {
			...
			"\n\n hstart Design hend" +
            "Based on the " +
            "linkstart href=https://www.digikey.com/short/hw5tvz75 hrefend ESP32 Development Modulelinkend" +
		...
		public static readonly Board Z22 = new()
        {
            ...
            BoardDescription =
            "hstart Board Description hend " +
			"Built specifically for the fireworks mortar project, this board was the backbone of the fireworks ignitor. " +
            "\n\n hstart Design hend" +
		...
		public static readonly Board Z23 = new()
        {
            ...
            BoardDescription =
            "hstart Board Description hend " +
			"Built specifically for the Fireworks Mortar Project, this small interconnect board provides what was planned to be a rapid connection point for firework ignitors to be connected between reloads of the mortar tubes. " +
            "\n\n hstart Design hend" +
		...
		public static readonly Board Z24 = new()
        {
            ...
            "Arduino using a locking connector, another Molex favorite, the linkstart href=https://www.molex.com/en-us/products/connectors/wire-to-board-connectors/micro-fit-connectors hrefend Micro-Fitlinkend." +
			"paraend",
			Projects = new()
			{
				ProjectLoader.FireworkProject,
		...
		public static readonly Board Z25 = new()
        {
            ...
            BoardDescription =
            "hstart Board Description hend A very simple breakout board to breakout linkstart href=https://www.adafruit.com/product/2479 hrefend Adafruits Bluefruit Adapterlinkend. " +
            "Need I say anymore? " +
            "\n\n hstart Design hend" +
